...
<html>
    ...
    <body>
	    <div data-options="region:'center',border:false">
		    ...
		    <div class="easyui-window" id="addBatchWin" data-options="modal:true,closed:true,resizable:false,
		        ...
		        <table id="addBatchDatagrid" style="width:100%;">
		            <thead>
		                <tr>
		                    <th data-options="field:'name',editor:{type:'text'}">雇员姓名</th>
		                    <th data-options="field:'code',editor:{type:'text'}">雇员工号</th>
		                </tr>
		            </thead>
		        </table>
	    ...
	    $(function() {
	        $('#datagrid').datagrid({
	            url: '${ctx}/manager/employee/query',
	            toolbar: '#tools',
	            idField: 'id',
	            autoRowHeight: true,
	            fixed: true,
	            ...
	            columns: [[
	                ...
	                {field: 'name', title: '雇员姓名'},
	                {field: 'code', title: '雇员工号'},
	        ...
	        submitForm('${ctx}/manager/employee/saveOrUpdate');
	        deleteRow('${ctx}/manager/employee/deleteBatch');
	    });
	    function updateById(id) {
	        $.messager.progress();
	        var url = "${ctx}/manager/employee/getById"
	        var params = {id: id};
	        ...
	        if (endEditing()){
	            ...
	            if (rows.length) {
	                ...
	                if (inserted.length) {
	                    ...
	                    var url = "${ctx}/manager/employee/saveBatch"
